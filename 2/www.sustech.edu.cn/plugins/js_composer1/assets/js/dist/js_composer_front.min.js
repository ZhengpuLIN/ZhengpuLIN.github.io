...
function vc_initVideoBackgrounds() {
    jQuery(".vc_row").each(function() {
        ...
        $row.data("vcVideoBg") ? (youtubeUrl = $row.data("vcVideoBg"),
...
"function" != typeof window.vc_accordionBehaviour && (window.vc_accordionBehaviour = function() {
    jQuery(".wpb_accordion").each(function(index) {
        ...
        !isNaN(jQuery(this).data("active-tab")) && 0 < parseInt($this.data("active-tab")) ? parseInt($this.data("active-tab")) - 1 : !1), collapsible = !1 === active_tab || "yes" === $this.data("collapsible");
